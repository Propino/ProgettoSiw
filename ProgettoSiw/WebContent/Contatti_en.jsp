			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-3 col-md-offset-1">
					<div class="about-text">
						...
						<p>Contact the associated hotels on the list for discover the
							shuttle service that will transport you to establishment!</p>
						<p onclick="showHotel()" style="cursor: pointer;">
							<strong>Click for the list of associated hotels!</strong>
						</p>
