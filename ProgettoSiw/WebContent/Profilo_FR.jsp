	...
	<div class="container" style="margin-bottom: 10%; margin-top: 3%;">
		...
		<div class="row">
			<div class="col-sm-3">
				...
				<ul class="list-group">
					<li class="list-group-item text-muted">Activités <i
						class="fa fa-dashboard fa-1x"></i></li>
					<li class="list-group-item text-right"><span class="pull-left"><strong>Critiques</strong></span>
						${recensioni}</li>
				</ul>
			...
			<div class="col-sm-9">
				<ul class="nav nav-tabs">
					...
					<li><a data-toggle="tab" href="#log">Réservation</a></li>
					<li><a data-toggle="tab" href="#recensioni">Critiques</a></li>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="home">
						...
						<div class="col-xs-6">
							<label for="last_name"><h4>Nome de famille</h4></label>
							<p class="campi_profilo">${user.getCognome()}</p>
						</div>
						<div class="col-xs-6">
							<label for="mobile"><h4>Telephone</h4></label>
					...
					<div class="tab-pane" id="log">
						<div class="col-xs-3 log_intestazione">
							<ul class="list-group">
								<li class="list-group-item"
									style="font-weight: bold; font-style: italic;">Date</li>
						...
						<div class="col-xs-9 log_intestazione">
							<ul class="list-group">
								<li class="list-group-item"
									style="font-weight: bold; font-style: italic;">Places réservées</li>
								<c:forEach items="${posti}" var="posti">
									<li class="list-group-item">Place N° ${posti}</li>
								</c:forEach>
							</ul>
						</div>
					...
					<div class="tab-pane" id="recensioni">
							...
							<div class="well well-sm" style="margin-top: 5%;">
								<div class="text-center">
									<a class="btn btn-success btn-green" href="#reviews-anchor"
										id="open-review-box">Écrire une critique!</a>
								</div>
									...
									<div class="col-md-12">
										<form accept-charset="UTF-8" action="" method="post">
											...
											<textarea class="form-control animated" cols="50"
												...
												placeholder="Entrez vous critique..." rows="5"></textarea>
											...
											<div class="col-md-6">
												<button class="btn btn-warning btn-red rew"
													id="close-review-box">Proche</button>
												<button class="btn btn-success btn-green rew" type="button"
													onclick="inviaRecensione()">Soumettre!</button>
											</div>
										</form>
									</div>
								</div>
						...
						<div class="col-md-12">
							<h2 class=text-center>Mes critiques  </h2>
						</div>
