					...
					<div class="nav navbar-nav navbar-right">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a id="to_profilo" href="ProfiloServlet">Aller au profile</a></li>
								<li class="divider"></li>
	...
	<div class="row" style="margin-right: 0px; margin-left: 0px;">
		...
		<div class="col-sm-5">
			<div id="scritta_e_data_su_mappa">
				<h2 id="scritta_in_cima_alla_mappa">Choisissez votre lieu</h2>
				<form method="Get" action="MappaServlet"
					...
					<div id="back_data_submit_prenota">
						...
						<p style="display: inline; color: red; margin-left: 1%;"
							id="erroreData"></p>
						<input type="submit" value="Recherche" id="submit_button_data_mappa"
							href="MappaServlet">
					</div>
				</form>
				<c:if test="${dataview != null}">
					<p id="data_Selezionata">Date choisie: ${dataview}</p>
				</c:if>
			</div>
		</div>
	</div>
	<div class="row" style="margin-right: 0px; margin-left: 0px;">
		...
		<form>
			...
			<div class="col-sm-4" id="column_payment">
				...
				<div id="scrittaa">
					<p id="coupon">Vous avez un coupon ?</p>
					<input type="text" name="input_coupon" id="input_coupon"
						placeholder="Entrez vous coupon" class="form-control">
					...
					<c:if test="${user != null}">
						<input type="button" id="prosegui_pagamento"
							onclick="functione_pay()" value="Aller au paiement">
					</c:if>
					<c:if test="${user == null}">
		...
		<div class="modal-content">
			...
			<div class="panel panel-default credit-card-box">
				<div class="panel-heading display-table">
					<h3 class="panel-title display-td text-center">Effectuer le
Se connecter</h3>
				</div>
						...
						<div class="col-xs-12">
							<div id="pulsante">
								<button class="btn btn-success btn-lg btn-block" type="button"
									onclick="loginPopup()" id="submit_popup_login">Soumettre</button>
							</div>
						</div>
					</div>
			...
			<div class="panel panel-default credit-card-box">
				<div class="panel-heading display-table">
					<div class="row display-tr">
						<h3 class="panel-title display-td">Détails du paiement</h3>
				...
				<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input type="tel" class="form-control" name="cardNumber"
										placeholder="Valid Numero de varte" /> <span
					...
					<div class="row">
						...
						<div class="col-xs-5 col-md-5 pull-right">
							<div class="form-group">
								<label for="cardCVC">CODE CV</label> <input type="tel"
					...
					<div class="row">
						<div class="col-xs-12">
							<button class="btn btn-success btn-lg btn-block" type="button"
								onclick='var d="${dataview}"; prenotazione(d);'>Soudure</button>
						</div>
					</div>
