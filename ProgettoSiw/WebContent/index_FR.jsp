...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="nav_collassata">
				<ul class="nav navbar-nav navbar-left">
					...
					<li><a class="nav_text_button" href="StrutturaServlet">La structure</a></li>
	...
	<div id="features">
		<div class="container">
			<div id="intestazione">
				<h2>La nouvelle façon de réserver votre place à la plage</h2>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-4">
					<div class="features-item">
						...
						<p>Choisissez l'endroit que vous préférez sur la carte.</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-4">
					<div class="features-item">
						...
						<p>Votre place au bord de la mer à portée de clic.</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-4">
					<div class="features-item">
	...
	<h2 class=text-center>
		<a href="paginaRecensioni">Les avis de nos clients</a>
	</h2>
