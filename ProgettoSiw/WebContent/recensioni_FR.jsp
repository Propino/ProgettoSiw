...
<body>
	...
	<h2 id="whatguestthink">Qu'en pensent-ils? nos clients!</h2>
	<div class="col-md-12">
		<div class="col-md-4 filtro_stelle">
			<div id="5stelle" class="stelle_nel_filtro">
				...
				<input type="button" value="5" id="5s" onclick="cerca(this.id)"><label
					class="filtri" for="5s">5 étoiles</label>
			</div>
			<div id="4stelle" class="stelle_nel_filtro">
				...
				<label class="mdi mdi-star vuote"></label> <input type="button"
					value="4" id="4s" onclick="cerca(this.id)"><label
					class="filtri" for="4s">4 étoiles</label>
			</div>
			<div id="3stelle" class="stelle_nel_filtro">
				...
				<input type="button" value="3" id="3s" onclick="cerca(this.id)"><label
					class="filtri" for="3s">3 étoiles</label>
			</div>
			<div id="2stelle" class="stelle_nel_filtro">
				...
				<input type="button" value="2" id="2s" onclick="cerca(this.id)"><label
					class="filtri" for="2s">2 étoiles</label>
			</div>
			<div id="1stelle" class="stelle_nel_filtro">
				...
				<input type="button" value="1" id="1s" onclick="cerca(this.id)"><label
					class="filtri" for="1s">1 étoile</label>
			</div>
			<div id="mostra_tutti" class="stelle_nel_filtro">
				<input type="button" value="6" id="6s" onclick="cercaTutte()"><label
					style="padding-left: 0;" class="filtri" for="6s">Spectacle
					tous </label>
			</div>
		</div>
		<div class="col-md-2">
			<img src="img/tripadvisor.png" id="img_trip_advisor"
				alt="TripAdvisor">
		</div>
		<div class="col-md-4" id="trip_advisor">
			<h3>Ce que TripAdvisor pense de nous :</h3>
			<h5>"Le FlamingoBeachClub est un lieu magique. Chaque genre de
le confort est à la disposition du client et le naturel de l'endroit est entre
le meilleur du quartier."</h5>
		</div>
	</div>
